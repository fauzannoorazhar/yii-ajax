...
/**
 * ArtikelKategoriController implements the CRUD actions for ArtikelKategori model.
 */
class ArtikelKategoriController extends Controller
{
    ...
    /**
     * Lists all ArtikelKategori models.
     * @return mixed
     */
    ...
    /**
     * Displays a single ArtikelKategori model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ArtikelKategori model.
    ...
    /**
     * Updates an existing ArtikelKategori model.
    ...
    /**
     * Deletes an existing ArtikelKategori model.
    ...
    /**
     * Finds the ArtikelKategori model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ArtikelKategori the loaded model
    ...
    public function exportExcel($params)
    {
        ...
        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data ArtikelKategori');
